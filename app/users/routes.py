...
def account():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('users.account')) # this line forces the browser to send another get request preventing the 'do you want to submit your data again?' issue
